  ...
  renderConsolidatedL2DayShifts(today, todayKey) {
    ...
    if (dow === 0) {
      ...
      l2Html = `
        <div style="background: #ffffff; padding: 0.4rem 0.6rem; border-radius: 6px; border: 1px solid #cbd5e1;">
          <strong style="font-size: 0.76rem; color: #0f172a; display: block; margin-bottom: 3px;">1º Turno (Manhã):</strong>
          <span class="worker-chip color-normal" style="font-size: 0.76rem; padding: 2px 7px;">MATHEUS</span> <span class="worker-chip color-normal" style="font-size: 0.76rem; padding: 2px 7px;">SALETE</span>
        </div>
        <div style="background: #ffffff; padding: 0.4rem 0.6rem; border-radius: 6px; border: 1px solid #cbd5e1;">
          <strong style="font-size: 0.76rem; color: #0f172a; display: block; margin-bottom: 3px;">3º Turno (Noite):</strong>
          <span class="worker-chip color-normal" style="font-size: 0.76rem; padding: 2px 7px;">LÍVIA</span> <span class="worker-chip color-normal" style="font-size: 0.76rem; padding: 2px 7px;">NATÁLIA</span>
        </div>
      `;
    }
  ...
  shareTodayWhatsApp() {
    ...
    if (dayData && dayData.slots) {
      ...
      dayData.slots.forEach((s, idx) => {
        ...
        l1Text += `  • *${shiftLabels[idx]}*: ${names || 'Sem escala'}\n`;
      });
    } else {
